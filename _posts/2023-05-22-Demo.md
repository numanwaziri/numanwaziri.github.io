...
## **Births - Exploratory Data Analysis**
...
The graph showcases the birth rate rankings of the top six states that have experienced significant fluctuations since 1910. It conveys the dynamic nature of birth rates over time and offers insights into the changes to rank positions of these states. 

![Power-Law](rank_flactuations.png)_figure 6_

The bar plot displays the top 10 states with the highest number of births. **Strikingly**, the total births in these states surpass the combined births of all other states. This emphasizes the concentrated contribution of these states to the overall national birth statistics.
...
## **Names - Exploratory Data Analysis**
...
![Power-Law](unique_1.png)_figure 11_

### Proportion of Unique Baby Names Each Year

![Power-Law](unique_2.png)_figure 11_
